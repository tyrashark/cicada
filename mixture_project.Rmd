...
?kmeans
result_kmeans = kmeans(x, K, iter.max = 100, nstart = 1000)
result_kmeans = kmeans(x, K, iter.max = 100, centers = sort(result_kmeans$centers))
mu0 = result_kmeans$centers
n_K = as.vector(table(result_kmeans$cluster))
p0 = n_K/351
p0

nu0 = 1/(result_kmeans$withinss / (n_K-1))
